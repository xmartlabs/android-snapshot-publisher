...
open class FabricReleaseConfig {
  var distributionEmails: List<String>? = Constants.FABRIC_DEPLOY_DISTRIBUTION_EMAILS_DEFAULT_VALUE
  var distributionGroupAliases: List<String>? = Constants.FABRIC_DEPLOY_DISTRIBUTION_GROUP_ALIASES_DEFAULT_VALUE
